...
namespace IndieNeat {
    ...
    /*!\brief Allows to interpret Genotype into Phenotype.
     *
     * With this class, you can create a phenotype based on the given genotype. It
     * will allows you to compute the result of your model in terms of the inputs.
     * @tparam numInputs Describe how many input takes the phenotype.
     * @tparam numOutputs Describe how many outputs has the phenotype.
     */
    ...
    public:
        ...
        /*!\brief Construct a phenotype with a given genome.
         *
         * Construct a phenotype based on the given genome.
         * @param genome Contains all the information about the genome to construct the phenotype.
         */
        Phenotype(Genotype <numInputs, numOutputs> const &genome)
                : _genome(genome) {}

        /*!\brief Destructor of Phenotype class.
         * Destructor of Phenotype class.
         */
        ~Phenotype(void) {
            ...
            for (typename Genotype<numInputs, numOutputs>::Gene *gene : genes) {
                if (gene->isEnabled()) {
                    ...
                    it1 = std::find_if(nodes.begin(), nodes.end(),
                                       [&](typename Genotype<numInputs, numOutputs>::Node *node) -> bool {
